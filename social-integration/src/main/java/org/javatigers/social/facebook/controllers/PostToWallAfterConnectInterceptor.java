...
public class PostToWallAfterConnectInterceptor implements
	...
	private static final Logger logger = LoggerFactory.getLogger(PostToWallAfterConnectInterceptor.class);
	...
	public void postConnect(Connection<Facebook> connection, WebRequest request) {
		if (request.getAttribute(POST_TO_WALL_ATTRIBUTE,
			...
			try {
				connection
						.updateStatus("Connected with social integration app!");
				logger.debug("Status updated Connected with social integration app!");
		...
		logger.debug("postConnect of  PostToWallAfterConnectInterceptor");
	}
